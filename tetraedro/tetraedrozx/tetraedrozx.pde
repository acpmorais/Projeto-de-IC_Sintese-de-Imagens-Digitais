...
void projecaoyz(float p1[], float p2[], float p3[]){
  ...
  for (alpha = 0.0; alpha < 1.0; alpha += 0.01){
    ...
    for (gamma = 0.0; gamma < 1.0; gamma += 0.01){
      ...
      img.set(((int)t[2]),((int)t[0]),color(((int)(alpha*255)),((int)(beta*255)),((int)(gamma*255))));
    ...
    img.set(((int)r[2]),((int)r[0]),color(255,0,0));
    img.set(((int)s[2]),((int)s[0]),color(0,0,255));
